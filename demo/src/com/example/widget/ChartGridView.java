...
//        a.recycle();
    ...
    void setBounds(long start, long end) {
        ...
        mLabelStart = makeLabel(DataUsageSummary.formatDateRange(context, start, start));
        mLabelMid = makeLabel(DataUsageSummary.formatDateRange(context, mid, mid));
        mLabelEnd = makeLabel(DataUsageSummary.formatDateRange(context, end, end));
        invalidate();
    }
