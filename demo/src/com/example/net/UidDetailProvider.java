    ...
    private UidDetail buildUidDetail(int uid) {
        ...
        switch (uid) {
            ...
            case TrafficStats.UID_TETHERING:
                ...
                detail.label = res.getString(com.example.util.Utils.getTetheringLabel(cm));
                detail.icon = pm.getDefaultActivityIcon();
                return detail;
        }
        ...
        if (isKeyForUser(uid)) {
            ...
            if (info != null) {
                detail.label = com.example.util.Utils.getUserLabel(mContext, info);
                detail.icon = com.example.util.Utils.getUserIcon(mContext, um, info);
                return detail;
            }
        }
